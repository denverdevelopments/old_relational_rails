...
tgik.chefs.create!(name: "Lordon Gamsey", experience: 2, can_close: true)
...
wicks.chefs.create!(name: "Jessie Holiday", experience: 1, can_close: false)

miller.chefs.create!(name: "Jacque Milair", experience: 6, can_close: true)
